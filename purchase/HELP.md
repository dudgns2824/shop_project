...
* [Opurchase2 Client](https://docs.spring.io/spring-boot/docs/3.2.0/reference/htmlsingle/index.html#web.security.opurchase2.client)
...
* [Spring Boot and Opurchase2](https://spring.io/guides/tutorials/spring-boot-opurchase2/)
* [purchaseenticating a User with LDAP](https://spring.io/guides/gs/purchaseenticating-ldap/)

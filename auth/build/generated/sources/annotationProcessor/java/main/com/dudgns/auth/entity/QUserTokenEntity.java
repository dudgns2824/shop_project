...
public class QUserTokenEntity extends EntityPathBase<UserTokenEntity> {
    ...
    private static final long serialVersionUID = -1173352956L;
    ...
    public final com.dudgns.auth.entity.id.QUserTokenId id;
    ...
    public QUserTokenEntity(Class<? extends UserTokenEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.dudgns.auth.entity.id.QUserTokenId(forProperty("id")) : null;
    }
